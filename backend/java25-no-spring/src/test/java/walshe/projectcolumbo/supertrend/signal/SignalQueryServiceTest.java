...
class SignalQueryServiceTest {
    ...
    private static final Asset ASSET_A = new Asset(1, "AAAUSDT", Provider.BINANCE, true, AssetClass.CRYPTO, AssetVenue.SPOT, null, null);
    private static final Asset ASSET_B = new Asset(2, "BBBUSDT", Provider.BINANCE, true, AssetClass.CRYPTO, AssetVenue.SPOT, null, null);
    private static final Asset ASSET_C = new Asset(3, "CCCUSDT", Provider.BINANCE, true, AssetClass.CRYPTO, AssetVenue.SPOT, null, null);
